    ...
    <Modal title="Change Password" onClose={onClose}>
      {done ? (
        <div className="text-center py-4">
          ...
          <button
            onClick={onClose}
            className="w-full bg-fin-blue hover:bg-fin-blue-dark text-white font-bold py-3 rounded-xl text-sm transition-colors"
          >
            Done
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div key={label}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-11 py-3 border border-fin-border rounded-xl text-sm focus:outline-none focus:border-fin-blue focus:ring-2 focus:ring-fin-blue/10 transition-all"
                  />
                  <button
                    type="button"
                    onClick={() => toggle(i)}
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-fin-blue hover:bg-fin-blue-dark disabled:opacity-60 text-white font-bold py-3 rounded-xl text-sm transition-colors"
            >
  ...
  return (
    <Modal title="Delete Employer Account" onClose={onClose}>
      <div className="bg-fin-red-light border border-fin-red/20 rounded-xl p-4 flex gap-3 mb-5">
        <AlertTriangle
          size={18}
          className="text-fin-red flex-shrink-0 mt-0.5"
        />
        <div>
          <p className="text-sm font-bold text-fin-red mb-1">
            This action is permanent and irreversible.
          </p>
          <p className="text-xs text-fin-red/80 leading-relaxed">
            Deleting your employer account will remove your company profile, all
            posted internships, and applicant data.
          </p>
        </div>
      </div>
      <p className="text-sm text-fin-text mb-2">
        Type{" "}
        <span className="font-bold font-mono bg-fin-ground px-1.5 py-0.5 rounded text-fin-red">
          DELETE
        </span>{" "}
        to confirm:
      </p>
...
const applicants = [
  ...
  },
  {
    ...
    internship: "Software Development Intern",
    status: "review",
    appliedAt: "Sep 4, 2026",
    skills: ["Java", "React", "Node.js", "Docker"],
    matchScore: 88,
    avatar:
  ...
  },
  {
    ...
    program: "BSc CS & Information Systems",
    level: "Level 300",
    internship: "Software Development Intern",
    status: "applied",
    ...
    <div className="flex h-full overflow-hidden">
      ...
      <aside className="w-56 bg-fin-navy flex-shrink-0 flex flex-col hidden md:flex">
        <div className="px-4 py-4 border-b border-white/10 space-y-3">
          ...
          <div className="inline-flex items-center gap-1.5 bg-fin-gold/20 border border-fin-gold/30 rounded-full px-2.5 py-1">
            ...
            <span className="text-fin-gold text-[10px] font-bold">
              Employer Portal
            </span>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto bg-fin-ground">
        ...
        <div className="md:hidden bg-white border-b border-fin-border px-4 py-3 flex items-center justify-between">
          ...
          <button
            onClick={() => onNavigate("landing")}
            className="text-fin-muted text-xs font-medium"
          >
            Exit
          </button>
        </div>
        ...
        <div className="md:hidden flex overflow-x-auto gap-2 px-4 py-3 bg-white border-b border-fin-border">
          {[
            ...
            <button
              key={item.id}
              onClick={() => setPage(item.id as EmpPage)}
              className={`px-4 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all ${page === item.id ? "bg-fin-navy text-white" : "bg-fin-ground text-fin-muted"}`}
            >
              {item.label}
            </button>
          ))}
        ...
        <div className="p-4 md:p-6 animate-fade-in">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-fin-muted text-sm mt-1">
                  Welcome back, MTN Ghana · Manage your internships and
                  applicants.
                </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {dashboardStats.map((s) => (
                  <div
                    key={s.label}
                    className="bg-white rounded-2xl p-5 border border-fin-border shadow-sm text-center"
                  >
                    <div
                      className={`w-10 h-10 rounded-xl ${s.color} flex items-center justify-center mx-auto mb-3`}
                    >
                      <s.icon size={18} />
                    </div>
                    ...
                    <div className="text-xs text-fin-muted font-medium mt-1">
                      {s.label}
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-white rounded-2xl border border-fin-border overflow-hidden">
                <div className="flex items-center justify-between px-5 py-4 border-b border-fin-border">
                  <h3 className="font-bold text-fin-navy text-sm">
                    Recent Applicants
                  </h3>
                  <button
                    onClick={() => setPage("applicants")}
                    className="text-fin-blue text-xs font-semibold hover:underline"
                  >
                    View all
                  </button>
                </div>
                {applicants.slice(0, 3).map((ap) => (
                  <div
                    key={ap.id}
                    className="flex items-center gap-3 px-5 py-3.5 border-b border-fin-border last:border-0 hover:bg-fin-ground transition-colors cursor-pointer"
                    onClick={() => {
                      setSelectedApplicant(ap);
                      setPage("applicant-detail");
                    }}
                  >
                    <img
                      src={ap.avatar}
                      alt={ap.name}
                      className="w-9 h-9 rounded-full object-cover bg-fin-border"
                    />
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-fin-navy text-sm">
                        {ap.name}
                      </p>
                      <p className="text-xs text-fin-muted">
                        {ap.university} · {ap.program}
                      </p>
                    </div>
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${statusConfig[ap.status].color}`}
                    >
          ...
          {page === "post" && (
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="bg-white rounded-2xl border border-fin-border p-6 space-y-5">
                <div>
                  <label className="text-xs font-semibold text-fin-muted block mb-1.5">
                    Internship Title *
                  </label>
                  <input
                    type="text"
                    placeholder="e.g. Software Development Intern"
                    className="w-full px-3.5 py-3 border border-fin-border rounded-xl text-sm focus:outline-none focus:border-fin-blue focus:ring-2 focus:ring-fin-blue/10"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="Describe the internship role, work environment, and what the intern will do..."
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-fin-blue hover:bg-fin-blue-dark text-white font-bold px-4 py-2 rounded-xl text-sm transition-colors"
                >
              ...
              <div className="space-y-4">
                {empInternships.map((int) => (
                  <div
                    key={int.id}
                    className="bg-white rounded-2xl border border-fin-border p-5"
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${int.status === "active" ? "bg-fin-green-light text-fin-green" : "bg-fin-ground text-fin-muted"}`}
                          >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => setPage("applicants")}
                          className="flex items-center gap-1.5 bg-fin-blue-light text-fin-blue font-bold px-3 py-1.5 rounded-lg text-xs transition-colors hover:bg-fin-blue hover:text-white"
                        >
              ...
              <div className="space-y-3">
                {applicants.map((ap) => (
                  <div
                    ...
                    className="bg-white rounded-2xl border border-fin-border p-5 cursor-pointer hover:shadow-md hover:border-fin-blue/30 transition-all"
                  >
                    <div className="flex items-start gap-4">
                      <img
                        src={ap.avatar}
                        alt={ap.name}
                        className="w-12 h-12 rounded-xl object-cover bg-fin-border flex-shrink-0"
                      />
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-fin-muted text-xs">
                              {ap.university} · {ap.program} · {ap.level}
                            </p>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-bold text-fin-green bg-fin-green-light px-2 py-0.5 rounded-full">
                              {ap.matchScore}% Match
                            </span>
                            <span
                              className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${statusConfig[ap.status].color}`}
                        ...
                        <div className="flex flex-wrap gap-1.5 mt-2">
                          {ap.skills.slice(0, 4).map((s) => (
                            <span
                              key={s}
                              className="text-[10px] font-medium bg-fin-blue-mid text-fin-blue px-2 py-0.5 rounded-full"
                            >
                              {s}
                            </span>
                          ))}
          ...
          {page === "applicant-detail" && selectedApplicant && (
            <div className="space-y-5 max-w-2xl">
              <button
                onClick={() => setPage("applicants")}
                className="flex items-center gap-2 text-fin-muted hover:text-fin-text text-sm font-medium transition-colors"
              >
              ...
              <div className="bg-white rounded-2xl border border-fin-border overflow-hidden">
                <div className="bg-fin-navy p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">
                      {selectedApplicant.program} · {selectedApplicant.level}
                    </p>
                  ...
                  <div className="ml-auto">
                    <span className="text-lg font-bold text-fin-green bg-fin-green-light px-3 py-1.5 rounded-xl">
                ...
                <div className="p-5 space-y-5">
                  <div>
                    ...
                    <p className="font-bold text-fin-navy">
                      {selectedApplicant.internship}
                    </p>
                    <p className="text-xs text-fin-muted">
                  ...
                  <div>
                    <h4 className="font-bold text-fin-navy text-sm mb-2">
                      Skills
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {selectedApplicant.skills.map((s) => (
                        <span
                          key={s}
                          className="text-xs font-medium bg-fin-blue-mid text-fin-blue px-2.5 py-1 rounded-full"
                        >
                          {s}
                        </span>
                      ))}
                  ...
                  <div>
                    <h4 className="font-bold text-fin-navy text-sm mb-3">
                      Update Application Status
                    </h4>
                    <div className="grid grid-cols-2 gap-2">
                      {["review", "interview", "offer", "rejected"].map(
                        (status) => (
                          <button
                            key={status}
          ...
          {page === "account" && (
            <div className="space-y-5 max-w-xl">
              <div>
                ...
                <p className="text-fin-muted text-sm mt-1">
                  Manage your employer account, password, and preferences.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-fin-border overflow-hidden">
                ...
                {[
                  ...
                  <div
                    key={item.label}
                    className="flex items-center justify-between px-5 py-3.5 border-b border-fin-border last:border-0 hover:bg-fin-ground transition-colors cursor-pointer"
                  >
              ...
              <div className="bg-white rounded-2xl border border-fin-red/30 overflow-hidden">
                <div className="px-5 py-4 border-b border-fin-red/20 bg-fin-red-light/50">
                  <h3 className="font-bold text-fin-red text-sm flex items-center gap-2">
                    <AlertTriangle size={14} /> Danger Zone
                  </h3>
                </div>
                <div className="px-5 py-4 flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-fin-navy">
                      Delete employer account
                    </p>
                    <p className="text-xs text-fin-muted mt-0.5">
                      Removes your company profile, internships, and all
                      associated data permanently.
                    </p>
                  </div>
                  <button
                    onClick={() => setShowDeleteAccount(true)}
                    className="flex items-center gap-1.5 bg-fin-red-light hover:bg-red-100 text-fin-red font-bold px-3.5 py-2 rounded-xl text-xs transition-colors flex-shrink-0 ml-4 border border-fin-red/20"
                  >
